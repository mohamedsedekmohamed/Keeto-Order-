      ...
      <div className="relative flex items-center justify-center min-h-screen px-4 overflow-hidden transition-colors duration-300 bg-gray-50 dark:bg-zinc-950">
        ...
        >
          ...
          <div className="flex flex-col gap-4 mb-6">
            ...
            <div className="relative h-12 w-full">
              ...
              <div className="w-full h-full flex items-center justify-center gap-3 border-2 border-gray-200 dark:border-zinc-700 rounded-2xl bg-white dark:bg-zinc-800 text-gray-700 dark:text-white font-bold pointer-events-none transition-all">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="currentColor">
                  ...
                  <path d="M5.84 14.09c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V7.07H2.18C1.43 8.55 1 10.19 1 12s.43 3.45 1.18 4.93l3.66-2.84z" fill="#FBBC05" />
            ...
            >
              <AppleIcon className="w-5 h-5 dark:fill-white" />
