    ...
    <div className="bg-slate-50 text-slate-800 font-sans antialiased min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <main className="bg-white p-8 rounded-2xl shadow-xs border border-slate-100 prose prose-slate max-w-none">
          ...
          <p className="mb-4">
            To provide you with a seamless food ordering experience, we collect
          ...
          <ul className="list-disc pl-6 mb-4 space-y-1">
            ...
            <li>
              <strong>Social Authentication:</strong> If you choose to log in
              via Google Sign-In, we collect your Google profile information
              (Name, Email, and Profile Picture) in accordance with your
              permission settings.
            </li>
            <li>
              <strong>Location Data:</strong> We request access to your device's
              geolocation (via GPS) to help you set delivery addresses and
              browse nearby available restaurants accurately.
            </li>
            <li>
              <strong>Transaction & Wallet Details:</strong> We keep track of
              your order history, transaction receipts, and your current in-app
              Wallet balance.{" "}
              <em>
                We do not store complete Credit/Debit card numbers on our
                servers; card payments are processed securely via encrypted
          ...
          <p className="mb-4">
            We integrate trusted third-party services to ensure optimal
            application performance:
          </p>
          <ul className="list-disc pl-6 mb-4 space-y-1">
            <li>
              <strong>Google Firebase:</strong> Used for secure authentication,
              real-time database management, analytics, and sending push
              notifications about your order status.
            </li>
            <li>
              <strong>Google Maps API:</strong> Used to display interactive
              maps, verify address details, and track delivery coordinates.
            </li>
          </ul>
          ...
          <p className="mb-4">
            ...
            <a
              ...
              className="text-indigo-6xl hover:underline"
            >
          ...
          <p className="mb-2">
            Your information is used strictly to fulfill food delivery services,
            process cash/online/wallet transactions, update you on your orders,
            and secure your account from unauthorized activities.
          </p>
          ...
          <p className="mb-4">
            We highly respect your privacy control. You have the full right to
