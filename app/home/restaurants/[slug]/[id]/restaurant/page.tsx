    ...
    <div className="relative w-full min-h-screen pb-24 font-sans bg-white dark:bg-black">
      ...
      >
        <div className="relative">
          ...
          {totalItems > 0 && (
            <span className="absolute -top-2 -right-2 bg-zinc-900 text-white text-[10px] font-bold w-5 h-5 flex items-center justify-center rounded-full border-2 border-yellow-400 animate-in zoom-in">
              {totalItems}
            </span>
          )}
        </div>
