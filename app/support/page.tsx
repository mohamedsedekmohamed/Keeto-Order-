    ...
    <div className="bg-slate-50 text-slate-800 font-sans antialiased min-h-screen">
      <div className="max-w-4xl mx-auto px-4 py-12">
        <header className="text-center mb-12">
          <h1 className="text-4xl font-extrabold text-slate-950 tracking-tight mb-2">MyDr.shrimpo</h1>
        ...
        <main className="bg-white p-8 rounded-2xl shadow-xs border border-slate-100 prose prose-slate max-w-none">
          ...
          <p className="mb-6">Have any questions, facing an order tracking error, or having trouble with your digital wallet balance on MyDr.shrimpo? Our support team is here to assist you.</p>
          ...
          <div className="space-y-4 mt-4">
            ...
            <div className="border-l-4 border-slate-200 pl-4">
              <h4 className="font-semibold text-slate-900">What payment methods does MyDr.shrimpo accept?</h4>
