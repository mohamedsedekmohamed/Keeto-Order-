      ...
      <div className="flex items-center justify-between px-6 py-4 transition-colors duration-500 bg-white dark:bg-gray-950">
        ...
        <div className="flex items-center gap-12">
          ...
          <nav className="hidden gap-8 text-base font-medium text-gray-600 md:flex dark:text-gray-300">
            <Link
              href="/home"
              className="transition-colors duration-300 hover:text-yellow-500 dark:hover:text-yellow-400"
            >
              {t("home")}
            </Link>
        ...
        <div className="flex items-center gap-6">
          ...
          <Link
            href="/notification"
            className="relative text-gray-600 transition-all duration-300 dark:text-gray-400 hover:text-yellow-500 dark:hover:text-yellow-400 hover:scale-110 active:scale-95"
          >
          ...
          <Link
            href="/order"
            className="text-gray-600 transition-all duration-300 dark:text-gray-400 hover:text-yellow-500 dark:hover:text-yellow-400 hover:scale-110 active:scale-95"
          >
        ...
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          >
            ...
            <div className="flex flex-col p-4 space-y-4 text-gray-700 dark:text-gray-300">
              <Link onClick={() => setIsMobileOpen(false)} href="/home">
                Home
              </Link>
            </div>
